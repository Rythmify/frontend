...
// ─── Exported album summaries (for discoverHandlers) ─────────────────────────

export const mockAlbumPlaylists = [...mockPlaylists, ...mockLikedPlaylists]
  .filter((p) => p.is_album_view)
  .map(({ tracks: _tracks, ...summary }) => summary);
