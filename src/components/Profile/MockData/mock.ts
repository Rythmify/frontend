export const mockFollowing = [
  ...
  {
    username: "shahd-yehia",
    displayName: "Shahd Yehia",
    followers: 12000,
    tracks: 5,
    avatar: "",
    isVerified: false,
...
export const mockUserProfiles: Record<
  string,
  {
    displayName: string;
    avatar: string;
...
> = {
  "travis-scott": {
    ...
    coverUrl: "",
    location: "Houston, TX",
    bio: "Multi-platinum recording artist, producer, and creative director. Founder of Cactus Jack Records. UTOPIA out now.",
    followers: 6150000,
    following: 200,
    tracks: 174,
    likedTracks: [
      {
        ...
        artist: "Travis Scott",
        coverUrl:
          "https://i1.sndcdn.com/artworks-000225111730-qbt7bb-t500x500.jpg",
        plays: 95000000,
        likes: 1800000,
        reposts: 120000,
        comments: 20000,
  ...
  "farah-medhat": {
    ...
    bio: "Music lover based in Cairo. Always looking for new sounds to vibe to 🎵",
    followers: 7,
    following: 3,
    tracks: 0,
    likedTracks: [
  ...
  "shahd-yehia": {
    ...
    coverUrl: "",
    location: "Cairo, Egypt",
    bio: "Producer & artist from Cairo. Making beats and vibes since 2018.",
    followers: 12000,
    following: 150,
    tracks: 5,
    likedTracks: [
...
export const mockUserFollowers: Record<string, typeof mockFollowers> = {
  "farah-medhat": [
    ...
    {
      username: "Rowida Ahmed",
      displayName: "Rowida Ahmed",
      followers: 4,
      avatar: "",
      isVerified: false,
    },
