          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex w-1/2 relative top-2 justify-between items-center gap-6">
              <IconStat
                ...
                tierColor="gold"
                icon={
                 <svg height="35" fill="none" viewBox="0 0 75 72" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><g clip-path="url(#insights-a)"><path d="M51.335 48.698v-33.64l-10.24 3.83v4.63M35.965 45.168v-22.82l-10.25 3.82v5.23M25.885 51.398c-2.81-.65-7.32-.35-10.02.66l-13.51 5.04c-1.32.49-1.97 1.06-1.97 1.6 0 .56.73 1.08 2.17 1.41l46.58 10.71c2.81.65 7.32.35 10.02-.66l13.51-5.04c1.32-.49 1.97-1.06 1.97-1.6 0-.56-.73-1.08-2.17-1.41l-46.58-10.71Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path><path d="M.385 58.688c0-.53.65-1.11 1.97-1.6l13.51-5.04c2.7-1.01 7.21-1.3 10.02-.66l46.58 10.71c1.44.33 2.17.85 2.17 1.41v-4.81c0-.56-.73-1.08-2.17-1.41l-46.58-10.71c-2.81-.65-7.32-.35-10.02.66l-13.51 5.04c-1.32.49-1.97 1.06-1.97 1.6v4.81Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path><path d="M35.965 22.348v22.82l10.25 2.35v-22.82l-10.25-2.35ZM51.335 15.058v33.64l10.25 2.36v-33.64l-10.25-2.36Z" fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path><path d="m41.095 10.178 10.24-3.82 10.25 2.36-10.25 3.82-10.24-2.36Z" stroke="white" stroke-linecap="round" stroke-linejoin="round"></path><path d="M51.335 1.208v5.15l10.25 2.36v-5.16l-10.25-2.35Z" fill="white" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path><path d="m41.095 5.028 10.24-3.82v5.15l-10.24 3.82v-5.15Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path><path d="M18.685 51.358c.62-.1 1.26-.18 1.91-.23v-4.81c-.65.05-1.29.13-1.91.23v4.81ZM72.465 57.288l-46.58-10.71c-.62-.14-1.32-.23-2.07-.28v4.81c.74.05 1.45.14 2.07.28l46.58 10.71c1.44.33 2.17.85 2.17 1.41v-4.81c0-.56-.73-1.08-2.17-1.41Z" fill="currentColor"></path><path d="m20.595 30.228-10.25 3.82v11.41" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path><path d="m25.705 42.808 5.14 1.18v-11.41l-10.25-2.36v12.3c1.83-.13 3.69-.04 5.11.29Z" fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path></g><defs><clipPath id="insights-a"><path fill="#fff" transform="translate(.005 .828)" d="M0 0h75v70.7H0z"></path></clipPath></defs></svg>
                }
              />
              <IconStat
                to="#"
