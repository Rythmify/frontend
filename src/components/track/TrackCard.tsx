              ...
              {isOwner ? (
                <>
                  <ScBtn
                    ...
                    dataTest="track-card-btn-share"
                  />
                  <ScBtn
                    icon={<LuCopy size={14} />}
                    tooltip="Copy Link"
                    onClick={onCopyLink}
                    dataTest="track-card-btn-copy"
                  />
                  <ScBtn
                    icon={<TbArrowsExchange size={17} />}
                    tooltip="Replace File"
                    onClick={onReplaceFile}
                    dataTest="track-card-btn-replace"
                  />
                  <ScBtn
                    icon={<LuPencil size={13} />}
                    tooltip="Edit"
                    onClick={onEdit}
                    dataTest="track-card-btn-edit"
                  />
                  <MoreDropdown
                    isOwner
                    liked={liked}
                ...
                <>
                  ...
                  <ScBtn
                    ...
                    tooltip="Repost"
                    onClick={() => {}}
                    dataTest="track-card-btn-repost"
                  />
                  <ScBtn
                    icon={<HiArrowUpOnSquare size={17} />}
                    tooltip="Share"
