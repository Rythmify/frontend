      ...
      <div className={styles.toolsGrid}>
        {primaryTools.map((tool) => (
          <button key={tool.id} className={styles.toolButton}>
            <svg aria-label="Paywalled feature" style={{ position: "absolute", top: "6px", right: "6px" }} width="14" height="14" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><circle cx="8" cy="8" r="8" fill="#7564F5" fillOpacity=".15" /><path d="M7.389 4.477c.155-.636 1.067-.636 1.222 0l.48 1.957c.054.225.23.401.455.458l1.98.502c.632.16.632 1.052 0 1.212l-1.98.502a.627.627 0 0 0-.456.458l-.479 1.957c-.155.636-1.067.636-1.222 0l-.48-1.957a.627.627 0 0 0-.455-.458l-1.98-.502c-.632-.16-.632-1.052 0-1.212l1.98-.502a.627.627 0 0 0 .456-.458l.479-1.957Z" fill="#7564F5" /></svg>
