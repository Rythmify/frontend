    ...
    <div className="relative inline-block" ref={menuRef}>
      ...
      >
        ...
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          <path
            d="M12 14c1.66 0 2.99-1.34 2.99-3L15 5c0-1.66-1.34-3-3-3S9 3.34 9 5v6c0 1.66 1.34 3 3 3m-1.2-9.1c0-.66.54-1.2 
        ...
        <i
          className={`fa-solid fa-chevron-down text-[10px] transition-transform ${isMicMenuOpen ? "" : ""}`}
        />
      </div>
