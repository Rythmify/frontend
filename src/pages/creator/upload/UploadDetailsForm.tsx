      ...
      <div className="flex flex-col lg:flex-row gap-12 items-start">
        ...
        <div className="flex flex-col items-center shrink-0">
          ...
          <button
            ...
            className="relative w-100 h-100 bg-transparent border border-dashed border-[#333] flex flex-col items-center justify-center cursor-pointer hover:border-white transition-all group overflow-hidden"
          >
            {artwork ? (
              <>
                <img
