    ...
    <div className="container px-4 md:px-8 lg:px-20">
      ...
      <ProfileTabs
        ...
        onTabChange={(tab) => {
          ...
          if (tab === "All") navigate(base);
          if (tab === "Popular tracks") navigate(`${base}/popular-tracks`);
          if (tab === "Tracks") navigate(`${base}/tracks`);
          if (tab === "Albums") navigate(`${base}/albums`);
          if (tab === "Playlists") navigate(`${base}/sets`);
