...
describe("LibraryPage", () => {
  ...
  it("falls back to mock tracks when history store and API are both empty", () => {
    render(<LibraryPage />);
  ...
  it("uses history store entries instead of API tracks", () => {
  ...
  it("renders a TrackCard for track history entries", () => {
    (useHistoryStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      entries: [
        { type: "track", item: { id: "ht1" }, playedAt: "" },
      ],
  ...
  it("renders a StationCard for station history entries", () => {
    (useHistoryStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      entries: [
  ...
  it("renders a MadeForYouCard for mix history entries", () => {
    (useHistoryStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
  ...
  it("renders mixed entry types from history store", () => {
    (useHistoryStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      entries: [
        { type: "track", item: { id: "ht1" }, playedAt: "" },
        { type: "station", item: { id: "hs1", name: "Station" }, playedAt: "" },
  ...
  it("does not crash when a mix entry has a null label", () => {
    (useHistoryStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
  ...
  it("does not crash when a mix entry has an empty string label", () => {
    (useHistoryStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
  ...
  it("calls getRecentlyPlayed on mount", () => {
    render(<LibraryPage />);
    expect(getRecentlyPlayed).toHaveBeenCalledTimes(1);
  });

  it("calls getMyPlaylists (library service) on mount", () => {
    render(<LibraryPage />);
    expect(getMyPlaylistsLib).toHaveBeenCalledTimes(1);
  });

  it("calls getMyFollowing on mount", () => {
    render(<LibraryPage />);
    expect(getMyFollowing).toHaveBeenCalledTimes(1);
  });

  it("calls playlist service APIs on mount", () => {
    render(<LibraryPage />);
  ...
  it("shows 'All' as the default filter label", () => {
    render(<LibraryPage />);
    expect(screen.getByTestId("library-playlist-filter-toggle")).toHaveTextContent("All");
  });

  it("opens filter dropdown when toggle is clicked", () => {
    render(<LibraryPage />);
  ...
  it("updates toggle label after selecting 'Created'", () => {
    render(<LibraryPage />);
    fireEvent.click(screen.getByTestId("library-playlist-filter-toggle"));
  ...
  it("updates toggle label after selecting 'Liked'", () => {
    render(<LibraryPage />);
    fireEvent.click(screen.getByTestId("library-playlist-filter-toggle"));
    fireEvent.click(screen.getByTestId("library-playlist-filter-option-liked"));
  ...
  it("shows liked playlists from store when 'Liked' filter is selected", () => {
  ...
  it("hides liked playlists when 'Created' filter is selected", () => {
    (useLikesStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      ...defaultLikes,
      likedPlaylists: [makePlaylistCard("lp1", "Liked Playlist")],
    });
  ...
  it("renders a synthetic card for following_ids not returned by the API", () => {
    (useAuthStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
  ...
  it("renders no following cards when following_ids is empty and API returns nothing", () => {
    render(<LibraryPage />);
  ...
  it("renders LikesContent in the Likes section", () => {
    render(<LibraryPage />);
  ...
  it("renders 'Browse trending playlists' link in Likes section", () => {
    render(<LibraryPage />);
    expect(screen.getByTestId("library-likes-browse")).toHaveAttribute("href", "/discover");
  });

  it("renders 'Browse trending playlists' link in Stations section", () => {
    render(<LibraryPage />);
  ...
  it("renders album cards from liked albums in store", () => {
    (useLikesStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      ...defaultLikes,
      likedAlbums: [
  ...
  it("renders station cards from liked stations in store", () => {
    (useLikesStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      ...defaultLikes,
      likedStations: [
  ...
  it("renders multiple station cards from liked stations", () => {
    (useLikesStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      ...defaultLikes,
      likedStations: [
