...
function SocialNetworks({
  ...
  const [connected, setConnected] = useState<Provider[]>(["google"]);
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button className="flex items-center gap-2 px-4 py-2 text-sm border border-[var(--color-border)] bg-[var(--color-bg-inverted)] text-[var(--color-bg)] rounded-[var(--radius-sm)] hover:opacity-90 transition-opacity duration-150">
          <svg
            width="16"
            height="16"
