...
export default function SigninPasswordLoginStep({ email, onBack, onContinue }: Props) {
  ...
  return (
    <>
      ...
      <div className="grid gap-5">
        ...
        <a href="/forgot-password" className="text-text-link hover:text-text-link-hover text-md">
